...
def create_mesh(
    ...
    while head < num_samples:
        sample_subset = samples[head : min(head + max_batch, num_samples), 0:60]
        # print("sample_subset",sample_subset)
        ...
        samples[head : min(head + max_batch, num_samples), 60] = (
